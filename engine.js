...
const BUILDINGS_BY_MAP={
  ...
  bootville:[
    {x:7, y:2, key:'lab',              w:3, h:3},  // entrance y=4
    {x:2, y:2, key:'house_a',          w:2, h:2},
    {x:17,y:2, key:'house_a',          w:2, h:2},
    {x:2, y:5, key:'house_b',          w:2, h:2},
    {x:17,y:5, key:'house_b',          w:2, h:2},
    {x:11,y:7, key:'fountain',         w:2, h:1},  // decorative, no collision
...
const MAP_TINT={
  ...
  gridlock:  {path:'rgba(0,60,100,0.10)',  wall:'rgba(10,10,60,0.25)'},
  route2:    {grass:'rgba(60,40,10,0.25)',   path:'rgba(80,60,30,0.20)',  wall:'rgba(60,40,20,0.25)'},
  ironhaven: {grass:'rgba(5,5,5,0.75)',      path:'rgba(80,50,10,0.15)',  wall:'rgba(30,20,10,0.30)'},
};
...
function drawTile(ctx,t,tx,ty,ts){
  ...
  const cityOverrides={
    ...
    ironhaven:{ grass:'gridlock_ground', path:'gridlock_path' },
  };
