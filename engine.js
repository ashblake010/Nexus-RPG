...
const BUILDINGS_BY_MAP={
  ...
  gridlock:[
    // gym(3,2) w:3 h:2 → blocks row 2 only, entrance row 3, NPC at (4,3)
    {x:3, y:2, key:'gym',              w:3, h:2},
    // center(13,2) w:3 h:3 → blocks rows 2-3, entrance row 4, NPC at (14,4)
    {x:13,y:2, key:'center',           w:3, h:3},
    // shop(19,2) w:2 h:2 → blocks row 2, entrance row 3, NPC at (20,3)
    {x:19,y:2, key:'shop',             w:2, h:2},
    // neon buildings — left and right side blocks
    {x:2, y:8, key:'neon_building',    w:2, h:4},
    {x:19,y:8, key:'neon_building',    w:2, h:4},
    // lamps — tall, blockBase only (base collision)
    ...
    // SYNTEK billboard — solid, blocks all rows
