...
const BUILDINGS_BY_MAP={
  ...
  gridlock:[
    ...
    {x:13,y:2, key:'center',           w:3, h:3},  // entrance y=4, NPC at (14,4) → nurse at (14,5)
    {x:19,y:2, key:'shop',             w:2, h:2},  // entrance y=3, NPC at (19,3)
    {x:2, y:5, key:'neon_building',    w:2, h:3},
    {x:20,y:5, key:'neon_building',    w:2, h:3},
    {x:5, y:8, key:'street_lamp',      w:1, h:1},  // h=1 = no collision
    {x:17,y:8, key:'street_lamp',      w:1, h:1},
    {x:5, y:13,key:'street_lamp',      w:1, h:1},
    {x:17,y:13,key:'street_lamp',      w:1, h:1},
    {x:10,y:10,key:'syntek_billboard', w:3, h:1},  // centre of map, decorative
  ],
  route2:[
  ...
  ironhaven:[
    ...
    {x:5, y:7, key:'street_lamp',      w:1, h:1},
    {x:17,y:7, key:'street_lamp',      w:1, h:1},
  ],
};
