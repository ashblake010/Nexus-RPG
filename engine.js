...
const BUILDINGS_BY_MAP={
  ...
  gridlock:[
    ...
    {x:2, y:5, key:'neon_building',    w:2, h:3},
    {x:20,y:5, key:'neon_building',    w:2, h:3},
    {x:5, y:8, key:'street_lamp',      w:1, h:2, blockBase:true},
    {x:17,y:8, key:'street_lamp',      w:1, h:2, blockBase:true},
    {x:5, y:13,key:'street_lamp',      w:1, h:2, blockBase:true},
    {x:17,y:13,key:'street_lamp',      w:1, h:2, blockBase:true},
    {x:10,y:10,key:'syntek_billboard', w:3, h:1},
  ],
  route2:[
...
const MAP_TINT={
  ...
  gridlock:  {grass:'rgba(0,5,15,0.82)',     path:'rgba(0,60,100,0.20)',  wall:'rgba(10,10,60,0.25)'},
  route2:    {grass:'rgba(60,40,10,0.25)',   path:'rgba(80,60,30,0.20)',  wall:'rgba(60,40,20,0.25)'},
  ironhaven: {grass:'rgba(5,5,5,0.88)',      path:'rgba(80,50,10,0.25)',  wall:'rgba(30,20,10,0.30)'},
};
...
function drawTile(ctx,t,tx,ty,ts){
  ...
  const cityOverrides={
    ...
    gridlock: { grass:'path',       path:'path' },
    ironhaven:{ grass:'path',       path:'path' },
  };
