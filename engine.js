...
const BUILDINGS_BY_MAP={
  ...
  bootville:[
    {x:7, y:2, key:'lab',              w:3, h:3},  // entrance y=4, Ada at (8,4)
    {x:2, y:2, key:'house_a',          w:2, h:2},  // left top house
    {x:14,y:2, key:'house_a',          w:2, h:2},  // right top house — moved away from pond
    {x:2, y:5, key:'house_b',          w:2, h:2},  // left mid house
    {x:14,y:5, key:'house_b',          w:2, h:2},  // right mid house — moved so Kael(16,7) is visible
    {x:12,y:9, key:'fountain',         w:2, h:1},  // fountain in open grass off path
    {x:5, y:10,key:'fence',            w:4, h:1},
    {x:13,y:10,key:'fence',            w:4, h:1},
  ],
  gridlock:[
    {x:3, y:2, key:'gym',              w:4, h:4},  // entrance y=5, NPC at (5,5)→(5,3)
    {x:14,y:2, key:'center',           w:4, h:4},  // entrance y=5, NPC at (16,5)
    {x:19,y:2, key:'shop',             w:2, h:2},  // entrance y=3, NPC at (20,3)
    {x:2, y:8, key:'neon_building',    w:2, h:4},  // left mid block
    {x:19,y:8, key:'neon_building',    w:2, h:4},  // right mid block
    {x:6, y:8, key:'street_lamp',      w:1, h:2, blockBase:true},  // left-mid lamp
    {x:16,y:8, key:'street_lamp',      w:1, h:2, blockBase:true},  // right-mid lamp (off road)
    {x:6, y:14,key:'street_lamp',      w:1, h:2, blockBase:true},  // left-low lamp
    {x:16,y:14,key:'street_lamp',      w:1, h:2, blockBase:true},  // right-low lamp
    {x:7, y:9, key:'syntek_billboard', w:2, h:2, blockBase:true},  // off road, collidable
  ],
  route2:[
  ...
  ironhaven:[
    {x:7, y:2, key:'gym',              w:3, h:2},  // entrance y=3, NPC at (8,3)
    {x:13,y:2, key:'center',           w:3, h:3},  // entrance y=4, NPC at (14,5)
    {x:19,y:2, key:'shop',             w:2, h:2},  // entrance y=3, NPC at (19,3)
    {x:1, y:8, key:'factory_iron',     w:4, h:4},
    {x:18,y:8, key:'syntek_plant',     w:4, h:4},
    {x:7, y:13,key:'metal_crate',      w:1, h:1},
    {x:9, y:14,key:'metal_crate',      w:1, h:1},
    {x:13,y:13,key:'metal_crate',      w:1, h:1},
    {x:15,y:14,key:'metal_crate',      w:1, h:1},
...
function drawTile(ctx,t,tx,ty,ts){
  ...
  const cityOverrides={
    ...
    route2:   { grass:'ground_r2',  path:'ground_r2' },
...
function canWalk(x,y){
  ...
  for(const b of getBuildingsForMap(G.map)){
    ...
    if(b.blockBase){
      // Block only the bottom row (lamp base, crate bottom, etc)
      if(y===b.y+b.h-1)return false;
    } else {
      // Block all rows except last (building entrance at front)
