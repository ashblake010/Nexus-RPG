...
const SHOP_ITEMS=[
  ...
  {key:'ether',    emoji:'🔷',name:'ETHER',     desc:'+10 PP to the lowest-PP move.',       price:300},
  {key:'maxEther', emoji:'🔹',name:'MAX ETHER', desc:'Fully restores PP of one move.',      price:700},
  {key:'elixir',   emoji:'🟣',name:'ELIXIR',    desc:'+10 PP to all moves.',                price:800},
  {key:'maxElixir',emoji:'💜',name:'MAX ELIXIR',desc:'Fully restores PP of all moves.',     price:1800},
];
function openShop(){
